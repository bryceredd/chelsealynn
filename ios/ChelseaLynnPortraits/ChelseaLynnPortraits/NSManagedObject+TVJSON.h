...
@interface NSManagedObject (TVJSON)
+ (id) objectWithObject:(id)arrayOrDictionaryOrStringkey; // upsert = YES, context = mainContext
+ (id) objectWithObject:(id)arrayOrDictionaryOrStringkey upsert:(BOOL)upsert; // upsert = YES, context = mainContext
+ (id) objectWithObject:(id)arrayOrDictionaryOrStringkey inContext:(NSManagedObjectContext*)context; // upsert = YES
